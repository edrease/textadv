//
//  ActionServiceDictionaries.swift
//  TEXTADV
//
//  Created by Edrease Peshtaz on 1/6/17.
//  Copyright © 2017 mysterio group. All rights reserved.
//

import Foundation

class ActionServiceDictionaries {
    
    let missionTwoFunctions: [String : (ViewController) -> [String]] = [
