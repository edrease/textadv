...
class Mission {
    ...
    init(missionName: String, briefing: [String : String], initialRoom: Room, disguiseOptions: [String], weaponOptions: [String], gadgetOptions: [String], statusItemOptions: [String]) {
